...
Breadcrumb paths such as `About Us / BSNL Bylaws`, `Events / Workshops`, and `News / Post title` are generated by the theme. Do not type manual return links into page content. To change a path, adjust the page parent, page slug, or post category and ask the website maintainer if the theme rule needs to be updated.
